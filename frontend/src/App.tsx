    ...
    return (
      <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '100vh', backgroundColor: '#f5f5f5' }}>
        <div style={{ textAlign: 'center' }}>
          <div style={{ fontSize: '18px', marginBottom: '20px', color: '#5B5FE8', fontWeight: 600 }}>正在加载数据...</div>
          <div style={{ width: '40px', height: '40px', border: '4px solid #ddd', borderTop: '4px solid #5B5FE8', borderRadius: '50%', animation: 'spin 1s linear infinite', margin: '0 auto' }} />
